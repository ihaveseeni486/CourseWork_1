...
"}")
        ...
        self.textEdit_report.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextSelectableByMouse)
...
"}")
        ...
        self.fill_settings.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
...
"}")
        ...
        self.clear_settings.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
...
"}")
        ...
        self.check_box_profile = QtWidgets.QCheckBox(self.frame)
        self.check_box_profile.setGeometry(QtCore.QRect(90, 130, 101, 21))
        self.check_box_profile.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.check_box_profile.setStyleSheet("QCheckBox\n"
"{\n"
...
"}")
        ...
        self.check_box_profile.setObjectName("check_box_profile")
        self.label_6 = QtWidgets.QLabel(self.frame)
        self.label_6.setGeometry(QtCore.QRect(30, 130, 61, 16))
        self.label_6.setObjectName("label_6")
        self.check_box_wall = QtWidgets.QCheckBox(self.frame)
        self.check_box_wall.setGeometry(QtCore.QRect(200, 130, 91, 20))
        self.check_box_wall.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.check_box_wall.setStyleSheet("QCheckBox\n"
"{\n"
"border : 2px solid rgb(160, 95, 182);\n"
"}\n"
"QCheckBox::indicator\n"
...
"}")
        ...
        self.check_box_wall.setObjectName("check_box_wall")
        self.check_box_album = QtWidgets.QCheckBox(self.frame)
        self.check_box_album.setGeometry(QtCore.QRect(300, 130, 101, 20))
        self.check_box_album.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.check_box_album.setStyleSheet("QCheckBox\n"
"{\n"
"border : 2px solid rgb(160, 95, 182);\n"
"}\n"
"QCheckBox::indicator\n"
...
"}")
        ...
        self.check_box_album.setObjectName("check_box_album")
        self.frame.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.check_box_profile.setText(_translate("MainWindow", "аватары"))
        self.label_6.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">Загрузка:</span></p></body></html>"))
        self.check_box_wall.setText(_translate("MainWindow", "стены"))
        self.check_box_album.setText(_translate("MainWindow", "альбомов"))
